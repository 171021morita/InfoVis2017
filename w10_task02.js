function main()
{
    ...
    function interpolation(value){
        return  Math.round( 255 * (value - colorMin) / (colorMax - colorMin));
    }
    
    /////////////////////////////////////////////////
    //カラーマップを0xFFFFFF〜0xFF0000に変更
    /////////////////////////////////////////////////
    // Create color map
    var cmap = [];
    for ( var i = 0; i < 256; i++ )
    ...
    {
        var id = faces[i];
        var S0 = interpolation( scalars[ id[0] ] );
        var S1 = interpolation( scalars[ id[1] ] );
        var S2 = interpolation( scalars[ id[2] ] );
